...
<head>
	...
	<!-- Start All Pages -->
	<div class="all-page-title page-breadcrumb-staff">
			...
			<div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        ...
                        <div class="team-content">
                            <h3 class="title">Ujdhesa Lika</h3>
                            <span class="post">Kitchen Manager</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        ...
                        <div class="team-content">
                            <h3 class="title">Serije Krasniqi</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        ...
                        <div class="team-content">
                            <h3 class="title">Steve King</h3>
                            <span class="post">Line Cook</span>
                        </div>
                    </div>
                </div>
            </div>
